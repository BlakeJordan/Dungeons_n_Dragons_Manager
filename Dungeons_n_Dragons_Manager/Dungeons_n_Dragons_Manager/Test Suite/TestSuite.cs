...
namespace Dungeons_n_Dragons_Manager.Test_Suite
{
    ...
    internal class TestSuite
    {
        ...
        public List<string> RunAllTests()
        {
            ...
            m_testingOutput.AddRange(new CreateMonsterViewmodel_Tests().RunAllTests()); //Add CreateMonsterViewmodel tests.
            m_testingOutput.AddRange(new EditMonsterViewmodel_Tests().RunAllTests()); //Add EditMonsterViewmodel tests.
